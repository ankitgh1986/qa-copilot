    ...
    def parse(
        ...
        try:
            ...
            return TestDesign(
                ...
                test_objectives=data.get("test_objectives", []),
                ...
                applicable_test_types=data.get("applicable_test_types", []),
                coverage_strategy=data.get("coverage_strategy", []),
                test_data_requirements=data.get(
                    "test_data_requirements",
                    [],
                ),
                automation_candidates=data.get(
